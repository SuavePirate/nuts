  ...
  describe("Resolve", function () {
    var version = {
      platforms: [
        ...
        {
          type: "windows_32_arm64",
          filename: "AtomSetup-arm64.exe",
          size: 78675720,
          content_type: "application/zip",
          download_url:
            "https://api.github.com/repos/atom/atom/releases/assets/825728",
    ...
    it("should resolve to best platform", function () {
      ...
      platforms
        .resolve(version, "win32_x86")
        .filename.should.be.exactly("AtomSetup.exe");
      platforms
        .resolve(version, "win32_x64")
        .filename.should.be.exactly("AtomSetup.exe");
      platforms
        .resolve(version, "win32_arm64")
        .filename.should.be.exactly("AtomSetup-arm64.exe");
      platforms
